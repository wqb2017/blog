 ...
 **************************提示********************************/
/* eslint-disable */
window.etpl = require('./template.min.js').etpl
etpl.config({
  commandOpen: '<%',
  commandClose: '%>',
})
;(function() {
  ...
  window.UMEDITOR_CONFIG = {
    ...
    toolbar: [
      ...
      ' emotion | image fullscreen | undo redo ',
    ],
    ...
    //fontsize
    //字号
    // 'fontsize':[10, 11, 12, 14, 16, 18, 20, 24, 36, 48, 60, 72, 96],
    ...
    whiteList: {
      ...
      div: ['style', 'class', 'id', 'data-src', 'data-index'],
      dl: ['style', 'class', 'id'],
      dt: ['style', 'class', 'id'],
      em: ['style', 'class', 'id'],
      embed: [
      ...
      img: ['src', 'alt', 'title', 'width', 'height', 'style', 'class', 'id', '_url', 'data-src', 'data-original', 'data-size', 'data-width', 'data-height'],
